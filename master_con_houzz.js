...
axios.post('https://protected-peak-85531.herokuapp.com/get_100_contractors_houzz', params)
    .then(function (response) {
      ...
      (async () => {
        ...
        axios.post('https://protected-peak-85531.herokuapp.com/save_100_contractors_houzz', { 'final_data':final_data })
        .then(function (response) {
